    ...
    return (
        <div className={styles.ourSpecialityContainer}>
            <div className={styles.ourSpecialityTextContainer}>
                ...
                <button className={"big-button high-emphasis-button " + styles.ourSpecialityContactButton}>FALE CONOSCO</button>
                <p className={styles.ourSpecialityBitrixPartnership} >
                    Nós somos parceiros oficiais do CRM n° 1 do mundo, o Bitrix24.<br/>
                    Implementamos, configuramos, treinamos o seu pessoal e mais.
                </p>
            </div>
            <Image className={styles.ourSpecialityImage} src={ourSpecialityImage} alt="People working together" />
        </div>
    )
}
